...
- NOTE: You can also modify the file named `Rprofile.site` in the `R/etc` directory in a similar way. In R console, use command line: `file.edit(file.path(R.home('etc')`, 'Rprofile.site'))` to edit it.¡¡But if do this way, it works for all Users(account) of the computer, while the previous method only works for you.
